...
import { Camera, Upload, FileText, X, Plus, ArrowRight } from 'lucide-react';
...
const Scan = () => {
  ...
  const handleProceed = () => {
    // TODO: Upload all dockets, trigger OCR, pass IDs via state
    navigate('/review', { state: { docketCount: dockets.length } });
  };
  ...
  return (
    <AppLayout>
      ...
      <div className="px-4 space-y-4">
        ...
        {/* Tips - only show when no dockets yet */}
        {dockets.length === 0 && (
